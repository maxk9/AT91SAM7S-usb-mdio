...
typedef struct {
	...
	uint16_t cmdlen;                        // last position in command line
	uint16_t cursor;                        // input cursor
	uint16_t (*execute) (uint16_t argc, const char * const * argv );            // ptr to 'execute' callback
	char ** (*get_completion) (uint16_t argc, const char * const * argv ); // ptr to 'completion' callback
